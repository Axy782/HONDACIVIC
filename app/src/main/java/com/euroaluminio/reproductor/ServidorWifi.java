...
public class ServidorWifi {
    ...
    private String paginaHtml() {
        return "<!DOCTYPE html><html lang='es'><head><meta charset='utf-8'>"
            ...
            + "<title>Enviar musica al radio</title><style>"
            ...
            + "</style></head><body>"
            + "<h1>Enviar musica al radio</h1>"
            + "<p>Elige las canciones (MP3) de tu celular y se copiaran a la carpeta Descarga del radio.</p>"
            + "<input id='f' type='file' accept='audio/*,.mp3' multiple style='display:none'>"
            + "<button class='btn' onclick=\"document.getElementById('f').click()\">+ Elegir canciones</button>"
